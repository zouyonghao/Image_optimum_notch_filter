...
public class OptimumNotchFilter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        noiseFT.toFastBitmap().saveAsPNG("img/catalano/image_noise_filtered1.png");
        noiseFT.Backward();
        noiseFT.toFastBitmap().saveAsPNG("img/catalano/image_noise_filtered2.png");
        ...
        finalImage.saveAsPNG("img/catalano/image_final.png");
        finalImageWithW.saveAsPNG("img/catalano/image_final_w.png");
        // showImage(ft.toFastBitmap());
